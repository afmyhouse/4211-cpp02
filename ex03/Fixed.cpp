...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/05/07 10:03:53 by antoda-s          #+#    #+#             */
/*   Updated: 2024/05/07 10:05:46 by antoda-s         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
Fixed :: Fixed(const float floatPointNum)
{
	...
	// std::cout << "PRE FIXED : " << fixedPointNumber << std::endl;
	// std::cout << "PRE FLOAT : " << floatPointNum << std::endl;
	this->fixedPointNumber = floatPointNum * (1 << Fixed::fractionalSize);
	// std::cout << "POS FIXED : " << fixedPointNumber << std::endl;
	// std::cout << "POS FLOAT : " << floatPointNum << std::endl;
}
